define(function () {
    ...
    function Layer(source, options) {
        ...
        if (source) {
            if (typeof source === "string" || typeof source === "object" && source.nodeName === "IMG") this.load(source, options);else if (typeof source === "object" && (source.nodeName === "CANVAS" || source instanceof ImageData)) this.fromCanvas(source, options);
        }
    }
