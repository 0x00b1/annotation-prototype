requirejs(['app/index', 'app/edit', 'helper/colormap', 'helper/util'], function (indexPage, editPage, colormap, util) {
    ...
    function createColormap(label, labels) {
        ...
        }) : [[0, 255, 255], [255, 255, 0], [255, 0, 255], [0, 0, 0]].concat(colormap.create("hsv", {
