define(["../helper/pagination", "../helper/segment-viewer", "../helper/util"], function (Pagination, Viewer, util) {
    function render(data, params) {
        ...
        for (let i = pagination.begin(); i < pagination.end(); ++i) {
            ...
            let viewer = new Viewer(data.imageURLs[i], data.annotationURLs[i], {
